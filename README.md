...
- **Direct 2-Step Email OTP Password Reset**: Fast self-service passcode recovery sending a 6-digit verification code directly to the registered user's email.
